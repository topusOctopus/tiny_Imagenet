...
from torchvision.models import resnet18, vgg11, resnet34, wide_resnet50_2
...
def train_simple_aug(args, model):
    """
    ...
    model_types = [VGG(), vgg11(), resnet18(), resnet34(), wide_resnet50_2()]
    model_types = [str(type(obj).__name__) for obj in model_types]
    if model_type == model_types[0]:
        pass
    elif model_type in model_types[2:5]:
